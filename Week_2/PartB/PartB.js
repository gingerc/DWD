...
app.get('/process_get', function(req, res){
    //send json
    var response = {"band name": req.query.userinput};
    console.log(response);
    var index = Math.floor(Math.random() * 10); //random 0-9 integar  
    
    res.send("<h1 style=\"color:" + color[index] + "; font-family: sans-serif; font-size: 12em; vertical-align:center;\">" + req.query.userinput+ insult +"</h1>");
